      ...
      <View style={styles.contentContainer}>
        ...
        >
          ...
          <View style={styles.mainBadge}>
            <Text style={styles.mainBadgeText}>Febre</Text> 
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                É a elevação da temperatura do corpo a partir dos 37,8 ºC;
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                Diante de situações de estresse, como efeito colateral após a utilização de algum medicamento ou como indicativo de infecção (inflamação);
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                ...
                <Text style={styles.chipText}> Conforto</Text>
              </View>
              <Text style={styles.treatmentDesc}>Retirar excesso de roupas, manter repouso, garantir circulação de ar no ambiente e utilização de compressas mornas;</Text>
            </View>

            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                <FontAwesome name="arrow-right" size={14} color="#5e718b" />
                <Text style={styles.chipText}> Beber líquidos</Text>
              </View>
            ...
            <View style={styles.treatmentItem}>
              ...
              <Text style={styles.treatmentDesc}>Utilização de antitérmicos conforme orientação médica.</Text>
            </View>
            </View>
          </View>
