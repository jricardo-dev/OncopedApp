      ...
      <View style={styles.contentContainer}>
        ...
        >
          ...
          <View style={styles.mainBadge}>
            <Text style={styles.mainBadgeText}>Fadiga / cansaço</Text> 
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                Sensação persistente de cansaço extremo que não melhora com o repouso;
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.treatmentItem}>
              ...
              <Text style={styles.treatmentDesc}>Manter períodos de repouso durante o dia, sem comprometer o sono da noite;</Text>
            </View>

            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                <FontAwesome name="arrow-right" size={14} color="#5e718b" />
                <Text style={styles.chipText}> Atividade física</Text>
              </View>
              <Text style={styles.treatmentDesc}>Prática de exercícios leves como caminhadas curtas, se autorizadas pela equipe médica;</Text>
            </View>

            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                <FontAwesome name="arrow-right" size={14} color="#5e718b" />
                <Text style={styles.chipText}> Alimentação</Text>
              </View>
              <Text style={styles.treatmentDesc}>Manter boa hidratação e alimentação balanceada.</Text>
            </View>
            </View>
          </View>
