      ...
      <View style={styles.contentContainer}>
        ...
        >
          ...
          <View style={styles.mainBadge}>
            <Text style={styles.mainBadgeText}>Alopécia</Text> 
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                Perda de cabelo relacionada ao tratamento;
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                Durante a quimioterapia e radioterapia;
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                ...
                <Text style={styles.chipText}> Recuperação</Text>
              </View>
              <Text style={styles.treatmentDesc}>Ao final da terapia, por volta de uma ou duas semanas, os cabelos voltam a crescer normalmente.</Text>
            </View>
            </View>
          </View>
