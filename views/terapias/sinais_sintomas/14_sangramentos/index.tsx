      ...
      <View style={styles.contentContainer}>
        ...
        >
          ...
          <View style={styles.mainBadge}>
            <Text style={styles.mainBadgeText}>Sangramentos</Text> 
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                Perda de sangue através de lesões internas ou externas, como por meio de manchas roxas na pele, sangramento no nariz ou gengiva;
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                Diante de algum trauma ou por causa do tratamento - atentar para diminuição das plaquetas;
              </Text>
            </View>
          </View>
          ...
          <View style={styles.cardSection}>
            ...
            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                ...
                <Text style={styles.chipText}> Urgência</Text>
              </View>
              <Text style={styles.treatmentDesc}>Se ocorrer fora da unidade hospitalar, procurar o serviço com urgência;</Text>
            </View>

            <View style={styles.treatmentItem}>
              <View style={styles.chipContainer}>
                <FontAwesome name="arrow-right" size={14} color="#5e718b" />
                <Text style={styles.chipText}> Registro</Text>
              </View>
              <Text style={styles.treatmentDesc}>Anotar características do sangue (volume, cor, viscosidade...) e informar para a equipe de saúde.</Text>
            </View>
            </View>
          </View>
