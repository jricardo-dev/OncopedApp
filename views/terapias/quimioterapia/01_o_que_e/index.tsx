          ...
          <View style={styles.cardWrapper}>
            ...
            <View style={styles.textCard}>
              <Text style={styles.bodyText}>
                É um tipo de tratamento para o câncer em que se utilizam
                medicamentos que destroem as células doentes que estão
                formando o tumor e impede que se espalhem pelo corpo.
                Os quimioterápicos atuam sem distinção, e atingem também
                as células normais, que pode causar efeitos colaterais.
              </Text>
            </View>
          </View>
        </ScrollView>
